...
class VMTermsUpdate:
    def __init__(self):
        ...
        print(VaL)
        for inu,c in enumerate(sheet['A2':'D'+VaL]):
            vendat.append([])
            vendatE.append([])
            for va in c:
    ...
    def sivin(self,venNum,venNam):
        ...
        for P,H in enumerate(vendat):
            ...
            try:
                ...
                if SITEMAT:
                    VMTermsUpdate.message = ('{}|{}|{}|{}|{}|{}'.format(H[0],H[1],H[2],'Org Type Changed to '+H[3],'Changes Made By Automation','Success'))
                    print('{}|{}|{}|{}|{}|{}'.format(H[0],H[1],H[2],'Org Type Changed to '+H[3],'Changes Made By Automation','Success'))
                else:
                    VMTermsUpdate.message = ('{}|{}|{}|{}|{}|{}'.format(H[0],H[1],H[2],'Something got error in Tax an Reporting','No Changes Made By Automation','Error'))
                    print('{}|{}|{}|{}|{}|{}'.format(H[0],H[1],H[2],'Something got error in Tax an Reporting','No Changes Made By Automation','Error'))
                ...
                if VENNOT == 'No results found.':
                    ...
                    # print('_'*88)
                    VMTermsUpdate.message = ('{}|{}|{}|{}|{}|{}'.format(H[0],H[1],H[2],'Vendor Not Found','No Changes Made By Automation','Error'))
                    print('{}|{}|{}|{}|{}|{}'.format(H[0],H[1],H[2],'Vendor Not Found','No Changes Made By Automation','Error'))
                    VMTermsUpdate.ElemX('//*[@id="POS_HT_SP_B_SUPP"]').click()
                ...
                if len(VENMUL) > 1:
                    ...
                    # print('_'*79)
                    VMTermsUpdate.message = ('{}|{}|{}|{}|{}|{}'.format(H[0],H[1],H[2],'Multiple Vendor Found','No Changes Made By Automation','Error'))
                    print('{}|{}|{}|{}|{}|{}'.format(H[0],H[1],H[2],'Multiple Vendor Found','No Changes Made By Automation','Error'))
                    VMTermsUpdate.ElemX('//*[@id="POS_HT_SP_B_SUPP"]').click()
